...
export const projectsFR: Record<Slug, Project> = {
  // ── 01 · Nu ─────────────────────────────────────────────────────────────
  nu: {
    slug: "nu",
    eyebrowNum: "01",
  ...
  bermuda: {
    ...
    signatureData: {
      bermudaIcons: {
        ...
        cards: [
          { title: "Créativité", sub: "Un nouveau concept à votre désir. À chaque fois." },
          { title: "Détail", sub: "Rien laissé au hasard. Chaque détail pensé." },
          { title: "Personnalité", sub: "La même personne, toujours là pour vous." },
        ],
        note: {
          heading: "Pourquoi c’est recoloré ici",
          body: [
            { t: "En ligne, Bermuda tourne sur sa propre identité aux tons terreux — argile, sable, olive. Pour cette étude de cas, j’ai remappé exactement la même métamorphose sur le système du portfolio : " },
            { t: "encre neutre", accent: true },
            { t: " au repos, montant au contraste maximal au focus, la forme focale en métamorphose se résolvant dans l’" },
            { t: "accent", accent: true },
            { t: ". La géométrie est intacte — seule la palette est échangée pour noir / blanc / accent, afin que le composant s’installe dans ce site au lieu de lutter contre lui." },
          ],
        },
      },
    },
  ...
  spiree: {
    ...
    signatureData: {
      spireeOrb: {
        ...
        meta: "TVA & livraison incluses dans l’UE",
        add: "Ajouter au panier",
        added: "✓ Ajouté au panier",
      },
    },
