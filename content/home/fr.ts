...
export const homeFR = {
  ...
  capabilities: {
    ...
    themeToggle: { light: "Clair", dark: "Sombre" },
    cards: [
      {
      ...
      },
      {
        ...
        h: "Clair & sombre, par conception",
        p: "Thème, accent, typographie — chaque décision visuelle est un token. Changez-en un et tout le système suit, en direct.",
        viz: "theme",
        case: { pre: "Faites-le vôtre ↑", href: "#capabilities" },
      },
    ],
  },
