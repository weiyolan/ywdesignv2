// NL home copy — full Dutch translation (Belgian/Flemish, Antwerp audience).
...
export const homeNL = {
  hero: {
    eyebrow: "Senior webdeveloper & designer · Antwerpen, BE",
    headline: [
  ...
  capabilities: {
    ...
    cards: [
      ...
      },
      {
        ...
        h: "AI, beheerst",
        p: "Prompt → nagekeken, geherstructureerde, begrepen code. Snelheid zonder de architectuur op te geven.",
        viz: "none",
        case: { pre: "Lees de filosofie ↓", href: "#ai" },
      },
    ],
  },
  ...
  work: {
    ...
    items: [
      { num: "01", cat: "Beauty & wellness e-commerce", slug: "nu", title: "Nu", body: "Een meertalige clean-beauty-winkel — rustige redactionele cadans rond een wrijvingsloze, CMS-gestuurde koopstroom.", href: "https://nu-site.netlify.app/en", img: "/work/nu.svg" },
      { num: "02", cat: "Fotografieportfolio", slug: "milo", title: "Milo Weiler", body: "Een cinematische, donkere portfolio opgedeeld in zeven scrollhoofdstukken — 55 projecten, sticky hoofdstuknavigatie, topscores op Lighthouse.", href: "https://miloweiler.com", img: "/work/milo.svg" },
      { num: "03", cat: "Eventbureau · België", slug: "bermuda", title: "Bermuda Events", body: "Een premium merksite die voorbije producties op schaal in beeld brengt, met een contacttrechter gebouwd om de juiste leads te kwalificeren.", href: "https://bermuda-events.be", img: "/work/bermuda.svg" },
      { num: "04", cat: "Activewearmerk · 100% Merino", slug: "spiree", title: "Spiree", body: "Een onafhankelijke sportkledingsite — gedurfd gradiëntsysteem, Sun- & Moon-collecties, een verhaalgedreven boog.", href: "https://spiree-next.netlify.app/", img: "/work/spiree.svg" },
    ],
  },
