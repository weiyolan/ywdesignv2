...
export const siteNL = {
  ...
  seo: {
    home: {
      title: "YWdesign — Senior webdeveloper & designer, Antwerpen",
      description:
      ...
      ogTitle: "YWdesign — Senior webdeveloper & designer, Antwerpen",
      ogDescription:
    ...
    columns: [
      ...
      },
      {
        ...
        links: [
          ...
          { label: "Bellen", href: "tel:+33638565302" },
        ] as NavLink[],
      },
    ],
    legal: [
      "© 2026 YWdesign",
      "VAT BE0794.586.584",
      "Hof Savelkoul 40, 2640 Mortsel, Antwerpen, België",
    ],
  },
};
